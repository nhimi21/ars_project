...
<div class="container col-12">
        ...
        <div class="search">
            <form action="/user/search" >
                <label>
                    ...
                    Leaving From
                    <input type="text" name="departureCity" placeholder="From" class="form-control"/>
                </label>
                ...
                <label>
                    ...
                    Going To
                    <input type="text" name="arrivalCity" placeholder="To" class="form-control"/>
                </label>
                <label>
    ...
    <div class="img-box col-">
        <div>
            ...
            <p>
                Please note that in Berlin the 2G rule applies to visitors aged 18 and over.
